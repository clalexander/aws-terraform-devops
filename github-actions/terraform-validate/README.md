...
The `terraform-validate` action is used to validate the Terraform configuration.

## Usage

```yaml
- uses: clalexander/aws-terraform-devops/github-actions/terraform-validate@v1
  env:
    # Terraform variables
